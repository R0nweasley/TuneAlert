...
public final class Song {
     ...
     * @param artist ชื่อคนเเต่งเพลง
     * @param tags ประเภทเพลง
     * @throws IllegalArgumentException ถ้า title หรือ artist เป็น null หรือ สตริงว่าง"", tags เป็น null และห้ามมีสมาชิกเป็น null หรือ สตริงว่าง""
     */
    ...
    //            (คำนวณจาก field ชุดเดียวกั    น — Objects.hash(...) ช่วยได้)
    @Override
    public int hashCode(){
